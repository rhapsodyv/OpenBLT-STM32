...
* Include files
****************************************************************************************/
#include "openblt/boot.h"                                /* bootloader generic header          */
#include "stm32_def.h"                          /* STM32 registers and drivers        */
...
void CpuStartUserProgram(void)
{
  ...
  TimerReset();
    ...
    // LL_APB1_GRP2_EnableClock(LL_APB1_GRP2_PERIPH_SYSCFG); //F0
    ...
    */
    // LL_SYSCFG_SetRemapMemory(LL_SYSCFG_REMAP_SRAM);  //F0
